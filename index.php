        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              ...
              <div class="item" id="slide2">
                <img src="images/_slider.jpg" alt="Chania">
                <div class="carousel-caption">
                  <h1>Make Your<br> Home<br> Organized</h1>
                  <p>GIVE YOUR FULL OF LOVE FOR THIS PLANET</p>
                  <a href="" class="btn-L">VIEW PRODUCTS</a>
     ...
     <div class="bg-white padding-section">
        <div class="container">
          <div class="row txt-center">
            ...
            <p class="col-xs-12 side-padding-10p color-949494 m-b-3">Hawker & Jonre PSD Template is an awesome design idea for your online shop. Clean Also it will be very easy to customize, enable you to either create a stunning layout of your own or just do some minor and some adjustments.</p>
          ...
          <div class="ourcol"><img src="images/IMG_20160517_234110_-1704803325.jpg"></div>
           <div class="row rownewsleft">
            <div class="col-md-3">
              ...
              <div id="datemonthleft"><b>MARCH</b></div>
            </div>
            </div>
            <div class="col-md-9">
            <div class="hhp">
    ...
    <div class="ourcol"><img src="images/plant1.jpg"></div>
            <div class="row rownewsright">
              <div class="col-md-3">
                ...
                <div id="datemonthright"><b>MARCH</b></div>
              </div>
              </div>
              <div class="col-md-9">
              <div class="hhp">
